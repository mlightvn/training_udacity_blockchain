...
contract Ownable {
    ...
    //  6) create a public function that returns the owner address
    ...
    modifier notOwner(address _address) {
        require(_address != owner, "Require Not owner");
        _;
    }

    modifier notZeroAddress(address _address) {
        require(_address != address(0), "Require Not Zero Address");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to, "You can't approve yourself");
    ...
    function _mint(address to, uint256 tokenId)
        internal
        // notZeroAddress(_tokenOwner[tokenId])
        notZeroAddress(to)
    {
    ...
    function _transferFrom(
        ...
        address to,
        uint256 tokenId
    ) internal notZeroAddress(_tokenOwner[tokenId]) notZeroAddress(to) {
...
contract CustomERC721Token is ERC721Metadata {
    ...
    // constructor must have only name and symbol as parameters, to match ERC721 rule, to deploy to OpenSea
